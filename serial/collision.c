...
static void find_partial_crossing_events_between_sphere_and_sector(const struct sector_s *sector_1, const struct sphere_s *sphere_1, const struct sector_s *sector_2) {
	int j;
